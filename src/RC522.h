...
#define RDM_BUFFER 20
struct spi_module service_spi_master_instance;
struct usart_module usart_instance;

TaskHandle_t xRFIDTask;

bool xStart,xTagRECV,xValidTAG;
uint8_t rdm_buffer[RDM_BUFFER];
